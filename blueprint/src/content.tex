...
\begin{definition}\label{def:binomial_filtration}
    \lean{ECCBinomial.Basic.binomial_filtration}
    \leanok
...
\begin{definition}\label{def:bond}
    \lean{ECCBinomial.Basic.B₀, ECCBinomial.Basic.B₁}
    \leanok
    \uses{def:parameters}
...
\begin{definition}\label{def:trading_strategy}
    \lean{ECCBinomial.Basic.trading_strategy}
    \leanok
...
\begin{definition}\label{def:arbitrage}
    \lean{ECCBinomial.Basic.arbitrage}
    \leanok
...
\begin{definition}\label{def:arbitrage_free}
    \lean{ECCBinomial.Basic.arbitrage_free}
    \leanok
    \uses{def:arbitrage}
...
\begin{lemma}\label{lem:arbitrage_free_condition}
    \lean{ECCBinomial.Basic.arbitrage_free_condition}
    \notready
...
\begin{lemma}\label{lem:q_in_unit_interval}
    \lean{ECCBinomial.Basic.q_in_unit_interval}
    \leanok
...
\begin{lemma}\label{lem:q_is_prob_measure}
  \lean{ECCBinomial.Basic.q_is_prob_measure}
...
\begin{lemma}\label{lem:discounted_stock_expectation}
  \lean{ECCBinomial.Basic.discounted_stock_expectation}
...
\begin{definition}\label{def:replicating_strategy}
    \lean{ECCBinomial.Basic.replicating_strategy}
    \leanok
...
\begin{theorem}\label{thm:replication_existence}
    \lean{ECCBinomial.Basic.replication_existence}
...
\begin{theorem}\label{thm:risk_neutral_pricing}
  \lean{ECCBinomial.Basic.risk_neutral_pricing}
...
\begin{corollary}\label{cor:call_price}
  \lean{ECCBinomial.Basic.call_price}
...
\begin{corollary}\label{cor:put_call_parity}
  \lean{ECCBinomial.Basic.put_call_parity}
